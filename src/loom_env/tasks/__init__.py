...
from .articulation import ArticulationTask
from .handover import HandoverTask
from .insertion import InsertionTask
...
TASKS = {
    "open_laptop": ArticulationTask,
    "close_laptop_partway": ArticulationTask,
    "insert_coin": InsertionTask,
